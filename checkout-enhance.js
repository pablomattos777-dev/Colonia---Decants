(()=>{
  ...
  // Keep the selected perfumes and total above the customer form.
  if(cartItems&&drawerFoot.parentElement){
    const drawer=drawerFoot.parentElement;
    if(cartItems.parentElement!==drawer) drawer.insertBefore(cartItems,drawerFoot);
  }
  ...
  form.innerHTML=`
    ...
    <div class="two">
      <div class="field"><label for="customerPhone">Teléfono <span class="required">*</span></label><input id="customerPhone" inputmode="tel" autocomplete="tel" placeholder="09X XXX XXX"></div>
      <div class="field"><label for="customerDocument">Documento <span class="required">*</span></label><input id="customerDocument" inputmode="numeric" placeholder="Cédula / documento"></div>
    </div>
    ...
    <div class="two">
      <div class="field"><label for="customerCity">Localidad <span class="required">*</span></label><input id="customerCity" autocomplete="address-level2" placeholder="Localidad"></div>
      <div class="field"><label for="customerDepartment">Departamento <span class="required">*</span></label><input id="customerDepartment" autocomplete="address-level1" placeholder="Departamento"></div>
    </div>
