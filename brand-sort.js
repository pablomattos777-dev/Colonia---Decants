(() => {
  const brandRules = [
    ...
    ['Azzaro', /Azzaro/i],
    ['Bharara Beauty', /Rome Extradose/i],
    ['Bvlgari', /Bvlgari/i],
    ...
    ['Maison Alhambra', /Glacier Bold|Lovely Chérie|Delilah Blanc|Delilha Blanc|Salvo Eau de Parfum|Salvo Elixir|Yeah!? Man Parfum/i],
